...
public class HBottomIndicatorItemView extends IndicatorBaseView {


    public HBottomIndicatorItemView(Context context) {
        this(context, null);
    }

    public HBottomIndicatorItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HBottomIndicatorItemView(Context context, AttributeSet attrs, int defStyleAttr) {
