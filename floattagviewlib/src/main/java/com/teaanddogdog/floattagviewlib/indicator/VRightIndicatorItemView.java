...
public class VRightIndicatorItemView extends IndicatorBaseView {


    public VRightIndicatorItemView(Context context) {
        this(context, null);
    }

    public VRightIndicatorItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VRightIndicatorItemView(Context context, AttributeSet attrs, int defStyleAttr) {
